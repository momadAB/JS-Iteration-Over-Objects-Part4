...
function updateCarColor(cars, id, newColor) {
  // Your code here
  // Tells us if the car with the given ID was found
  let wasCarFound = false;
  // If the car was found, this is the car object
  let newCar;
  ...
  // If we found the car, return the car object

  // If we did not find the car, return "No Car Found"
  if (wasCarFound === true) return newCar;
